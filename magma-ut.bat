...
set MAGMA_USER_SPEC=%MAGMA_UT_BASE_DIR%\Sources\Magma-UT\Magma-UT.s.m;%MAGMA_USER_SPEC%

::Set the MAGMA_UT startup file as Magma startup file
set MAGMA_STARTUP_FILE=%MAGMA_UT_BASE_DIR%\Sources\Magma-UT\Startup\Startup.m
