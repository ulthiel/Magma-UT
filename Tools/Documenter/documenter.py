...
docfile = open("Autodoc.md","w")
docfile.write("# "+package+" Autodoc\n")
docfile.write("## Statistics\n")
docfile.write("Lines: %o\n" % linecount)
docfile.write("Commands: %o\n" % commandcount)
docfile.write("Intrinsics: %o\n" % intrinsiccount)
docfile.write("Source files: %o\n" % sourcecount)

docfile.write("## Intrinsics\n")
for intrinsic in sorted(intrinsics.keys()):
	docfile.write("#### "+intrinsic+"\n")
